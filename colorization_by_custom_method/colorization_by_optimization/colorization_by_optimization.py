...
class ColorizationByOptimization:
    ...
    def __init__(self, source_image):
        ...
        if Image.isImageType(source_image):
    ...
    def colorization(self,is_recolor=False,debug_mode=False):
        ...
        if debug_mode:
            cv2.imshow("inner_colorizedRGB",cv2.cvtColor(colorizedRGB, cv2.COLOR_RGB2BGR))
            cv2.waitKey(0)
...
# source_image = "../../images/method2_example/m2_color_origin_example2.bmp"
# marked_image = "../../images/method2_example/m2_color_marked_example2.bmp"
# op = ColorizationByOptimization(Image.open(source_image))
# op.manually_set_marked_image(Image.open(marked_image))
# result_bgr = op.colorization(is_recolor=False,debug_mode=True)
# cv2.imshow("color-sample",result_bgr)
# cv2.waitKey(0)


# Case2: 使用事先准备好的标记图片进行彩色图像重上色
# source_image = "../../images/method2_example/m2_recolor_origin_example2.bmp"
# marked_image = "../../images/method2_example/m2_recolor_marked_example2.bmp"
# op = ColorizationByOptimization(Image.open(source_image))
# op.manually_set_marked_image(Image.open(marked_image))
# result_bgr = op.colorization(is_recolor=True,debug_mode=True)
